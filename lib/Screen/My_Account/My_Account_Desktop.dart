...
class _MyAccountDesktopState extends State<MyAccountDesktop> {
  ...
  double defaulttext=15; /// initialize local file image
  ...
  void update_profile(context) async{
...
// to get the url of the image from firebase storage
    ...
    FirebaseFirestore.instance.collection("Users").doc(FirebaseAuth.instance.currentUser?.uid.toString()).set(
      ...
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) =>  LandingPage("Accont desktop"))),
    });
  }
}
